...
\newcommand{\street}{Mühlfeldstraße 16}
\newcommand{\city}{4690 Schwanenstadt}
\address{\street}{\city}
...
\begin{document}
  ...
  \cventry{09/2006 -- 05/2010}{Lehre zum Mechatroniker}{Inocon Technologie GmbH}{Attnang-Puchheim}{}{Tätigkeitsbereich: Sondermaschinenbau}
...
%  \cvlistitem{Noch eine Publikation.}
  \section{Beruflicher Werdegang}
    \cventry{03/2018 -- 07/2018}{Berufspraktikum}{TGW Logistics Group}{Wels}{}{Entwicklung eines Predictive Maintenance Systems für Regalbediengeräte}
...
%  \cvcomputer{NI Vision Assistant}{\grade{1} \tab \textit{Grundkenntnisse}}{ROS Framework}{\grade{1} \tab \textit{Grundkenntnisse}}
  ...
  \cvline{\grade{4}}{C\#, Python}% \hfill\textit{sehr gute Kenntnisse}}
  \cvline{\grade{3}}{Java, Javascript, \LaTeX}% \hfill\textit{gute Kenntnisse}}
